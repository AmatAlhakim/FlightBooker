    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.LockedOut:
                    TempData["LockedOutMessage"] = "You have been locked out after entring incorrect password or email for more than 3 times";
                    TempData.Keep();
                    return View("Lockout");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    CustomerRepository cutomerRepo = new CustomerRepository();
                    Customer shareUser = new Customer();
                    shareUser.email = user.Email;
                    shareUser.first_name = user.UserName;
                    shareUser.password = user.PasswordHash;
                    shareUser.user_id = user.Id;
                    cutomerRepo.Add(shareUser);

					/*AspNetUser aUser = new AspNetUser();
					aUser.Id = user.Id;
					...
					aUser.LockoutEnabled = user.LockoutEnabled;

					AspNetUserRepository aspNetUserRepository = new AspNetUserRepository();
					aspNetUserRepository.Add(aUser);*/
